<template>
    <Head title="Редактировать материал" />

    <AdminLayout>
        <div class="space-y-6">
            <div class="flex items-center justify-between">
                <h1 class="text-3xl font-bold text-gray-900">Редактировать материал</h1>
                <a
...
const form = reactive({
    ...
    type: props.material.type || 'video',
    icon: props.material.icon || '▶️',
    lesson_number: props.material.lesson_number || null,
    links: props.material.links || [],
    is_new: props.material.is_new || false,
});

const submit = () => {
    router.put(`/admin/materials/${props.material.id}`, form);
};
</script>
